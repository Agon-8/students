...
//             PreparedStatement urdhri = lidhja.prepareStatement(query)
//        ) {
//            urdhri.setString(1, student.getName());
//            urdhri.setInt(2, student.getAge());
//            urdhri.executeUpdate();
//
...
//        ) {
//            urdhri.setLong(1, id);
//            ResultSet response = urdhri.executeQuery();
//            if (response.next()) {
